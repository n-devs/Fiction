    ...
    render() {
        ...
        return (
            <React.Fragment>
                ...
                <Dense>
                    {/* <IconButton onClick={this.props.history.goBack()} className={classes.menuButton} color="inherit" aria-label="Menu">
                        <KeyboardBackspaceIcon className={classes.avatar} />
                    </IconButton> */}
                    <BackButton/>
                    <Search />
                </Dense>
                ...
                <div className={classes.root}>
                    <GridList cellHeight={180} className={classes.gridList}>
                        <GridListTile key="Subheader" cols={2} style={{ height: 50 }}>
                            <ListSubheader component="div">เกมของฉัน</ListSubheader>
                        </GridListTile>
